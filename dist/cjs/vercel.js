    ...
    HonoRuntime.prototype.serve = function (options) {
        ...
        return function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        app = new hono_1.Hono().route((_b = (_a = options === null || options === void 0 ? void 0 : options.vercel) === null || _a === void 0 ? void 0 : _a.path) !== null && _b !== void 0 ? _b : '/api', this);
                        return [4, app.fetch(req)];
